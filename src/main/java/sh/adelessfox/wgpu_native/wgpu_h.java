...
public final class wgpu_h extends wgpu_h$shared {
    ...
    private static final int WGPUDx12SwapchainKind_Undefined = (int)0L;
    /**
     * {@snippet lang=c :
     * enum WGPUDx12SwapchainKind.WGPUDx12SwapchainKind_Undefined = 0
     * }
     */
    public static int WGPUDx12SwapchainKind_Undefined() {
        return WGPUDx12SwapchainKind_Undefined;
    }
    private static final int WGPUDx12SwapchainKind_DxgiFromHwnd = (int)1L;
    /**
     * {@snippet lang=c :
     * enum WGPUDx12SwapchainKind.WGPUDx12SwapchainKind_DxgiFromHwnd = 1
     * }
     */
    public static int WGPUDx12SwapchainKind_DxgiFromHwnd() {
        return WGPUDx12SwapchainKind_DxgiFromHwnd;
    }
    private static final int WGPUDx12SwapchainKind_DxgiFromVisual = (int)2L;
    /**
     * {@snippet lang=c :
     * enum WGPUDx12SwapchainKind.WGPUDx12SwapchainKind_DxgiFromVisual = 2
     * }
     */
    public static int WGPUDx12SwapchainKind_DxgiFromVisual() {
        return WGPUDx12SwapchainKind_DxgiFromVisual;
    }
    private static final int WGPUDx12SwapchainKind_Force32 = (int)2147483647L;
    /**
     * {@snippet lang=c :
     * enum WGPUDx12SwapchainKind.WGPUDx12SwapchainKind_Force32 = 2147483647
     * }
     */
    public static int WGPUDx12SwapchainKind_Force32() {
        return WGPUDx12SwapchainKind_Force32;
    }
    /**
     * {@snippet lang=c :
    ...
    private static class wgpuQueueGetTimestampPeriod {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            wgpu_h.C_FLOAT,
            wgpu_h.C_POINTER
        );

        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("wgpuQueueGetTimestampPeriod");
     ...
     * }
     */
    public static FunctionDescriptor wgpuQueueGetTimestampPeriod$descriptor() {
        return wgpuQueueGetTimestampPeriod.DESC;
    }
     ...
     * }
     */
    public static MethodHandle wgpuQueueGetTimestampPeriod$handle() {
        return wgpuQueueGetTimestampPeriod.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment wgpuQueueGetTimestampPeriod$address() {
        return wgpuQueueGetTimestampPeriod.ADDR;
    }
     ...
     * }
     */
    public static float wgpuQueueGetTimestampPeriod(MemorySegment queue) {
        var mh$ = wgpuQueueGetTimestampPeriod.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("wgpuQueueGetTimestampPeriod", queue);
            }
            return (float)mh$.invokeExact(queue);
        } catch (Error | RuntimeException ex) {
           throw ex;
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
